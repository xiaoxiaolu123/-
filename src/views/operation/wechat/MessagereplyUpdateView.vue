...
export default {
  ...
  methods: {
    ...
    save:function(){
        this.$request.put('mpWechatMessageReply/'+this.id,this.ruleForm).then(()=>{
  ...
  async created() {
    ...
    let res=await this.$request.get('mpWechatMessageReply/'+this.id);
