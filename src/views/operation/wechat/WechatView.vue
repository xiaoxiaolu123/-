                ...
                <template>
                    <el-table :data="tableData" style="width: 100% " class="table">
                        ...
                        <el-table-column label="操作" width="100">
                            <template>
                                <el-button type="text" size="middle" class="del">删除</el-button>
...
export default {
    ...
    methods: {
      ...
      this.size=size;
      this.$request.get('/mpWechatMessageReply', {
        params: {
          page: this.page,
          size: size
        }
