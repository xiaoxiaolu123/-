            ...
            <div class="bottom">
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    ...
                    <el-form-item label="天数" prop="days">
                        <template>
                            <el-input v-model="ruleForm.days" placeholder="天数" type="number"
                    ...
                    <el-form-item label="价格" prop="price">
                        <template>
                            <el-input v-model="ruleForm.price" type="number" placeholder="价格"
                                style="width:200px;margin-right: 20px;">
                            </el-input>
                            <i class="el-icon-info"></i>
                            <span>请输入整数</span>
                    ...
                    <el-form-item label="显示" prop="delivery">
                        <el-switch v-model="ruleForm.delivery" style="margin-right: 20px;"></el-switch>
                        <i class="el-icon-info"></i>
    ...
    methods: {
        ...
        save: function () {
            this.$request.post("/role",{
                ...
                expire_days:this.ruleForm.days,
                isShow:this.ruleForm.delivery,
                name:this.ruleForm.name,
                weight:0
            }).then((res)=>{
                if(res.status==0){
                    this.$router.push('/operate/role')
                }else{
