...
<template>
    <div class="meedu-main-body" v-if="user">
        <div class="back-bar-box mb-30" title="学员备注">
            <div class="btn-back" @click.stop="goBack">
                <i class="el-icon-back"></i>
                返回
            </div>
            <div class="line"></div>
            <div class="name">学员备注</div>
        </div>
        ...
        <div class="bottom-menus">
            <div class="bottom-menus-box">
                <el-button type="primary" class="save" :loading="loading" @click.stop="preservation">保存</el-button>
...
export default {
    ...
    methods: {
        ...
        preservation() {
            ...
            this.$request
                .put("http://1.14.239.98/backend/api/v1/member/" + this.id + "/remark", {
                    remark: this.remark,
                })
                .then(() => {
