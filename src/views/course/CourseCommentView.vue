  ...
  <div class="comment">
    ...
    <div class="tabBox">
      ...
      >
        ...
        <el-table-column prop="course.title" label="课程" width="223">
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getCourseDate: function () {
      this.$request.get(`course?page=1&size=10`).then((res) => {
        this.options = res.data.courses.data;
        // console.log(this.options);
      });
    },
    // 获取评论区数据// course_comment?page=1&size=10
    ...
    resetInput: function () {
      ...
      this.$nextTick(() => {
        this.getCommentData();
        // this.$options.methods.getCommentData();
      });
    },
    // 没有勾选要删除的数据
    open3() {
